...
## A6.2.1 · Open *User Management → Talents*

Note the four controls you will use:
...
## A6.2.3 · Split it into two working lists

by adding the **Statuses** chip. Each list is fixed in one direction, which is what keeps the work simple: Do one list at a time. Mix them and you lose track of which way a change was going.
...
## A6.2.4 · Narrow further with the keyword search box

Switch it to **Advanced** and the syntax hints appear right under it: Useful passes: `-consultant -advisory -advisor` strips out service providers; `"operating partner" "managing partner" principal` surfaces the buy-side titles.
...
## A6.2.6 · Freeze the list before you start reviewing
