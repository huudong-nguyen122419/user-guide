...
* [C2 · Source and invite talents](c2-source-and-invite-talents.md)
  * [C2.1 · Start from the project](c2-1-start-from-the-project.md)
  * [C2.2 · Narrow, then invite](c2-2-narrow-then-invite.md)
* [C3 · Work the applications](c3-work-the-applications.md)
  * [C3.1 · The six stages](c3-1-the-six-stages.md)
  * [C3.2 · Fit score and evidence](c3-2-fit-score-and-evidence.md)
  * [C3.3 · Move them along](c3-3-move-them-along.md)
* [C4 · Keep the pipeline moving](c4-keep-the-pipeline-moving.md)
  * [C4.1 · Live work](c4-1-live-work.md)
  * [C4.2 · Stale work](c4-2-stale-work.md)
  * [C4.3 · Interviews](c4-3-interviews.md)
  * [C4.4 · Finished work](c4-4-finished-work.md)
...
* [6 · Manage a campaign](6-manage-a-campaign.md)
  ...
  * [6.8 · Verify: Inbox & replies](6-8-verify-inbox-and-replies.md)
    * [6.8.1 · Read the numbers](6-8-1-read-the-numbers.md)
    * [6.8.2 · Open the Inbox](6-8-2-open-the-inbox.md)
    * [6.8.3 · Replies & their chips](6-8-3-replies-and-their-chips.md)
    * [6.8.4 · Filter by category](6-8-4-filter-by-category.md)
    * [6.8.5 · Answer a reply](6-8-5-answer-a-reply.md)
    * [6.8.6 · Chips that end it](6-8-6-chips-that-end-it.md)
    * [6.8.7 · Bounced / dropped](6-8-7-bounced-dropped.md)
  * [6.9 · Label the replies](6-9-label-the-replies.md)
  * [6.10 · Finish a campaign](6-10-finish-a-campaign.md)
    * [6.10.1 · Who finishes it](6-10-1-who-finishes-it.md)
    * [6.10.2 · Mark Campaign as Complete](6-10-2-mark-campaign-as-complete.md)
...
* [6‡ · Manage a campaign, issues](6-manage-a-campaign-issues.md)
  * [6‡.0 · The register](6-0-the-register.md)
    * [CMP-09 · Folder rail scope](cmp-09-folder-rail-scope.md)
    * [CMP-10 · Numbers lead nowhere](cmp-10-numbers-lead-nowhere.md)
    * [CMP-11 · Reply Rate](cmp-11-reply-rate.md)
    * [CMP-12 · No lifecycle on rows](cmp-12-no-lifecycle-on-rows.md)
    * [CMP-13 · Open / Click / Bounced](cmp-13-open-click-bounced.md)
    * [CMP-14 · Last replied](cmp-14-last-replied.md)
    * [CMP-15 · Owner picker](cmp-15-owner-picker.md)
    * [CMP-16 · Total Steps](cmp-16-total-steps.md)
    * [CMP-17 · Reordering steps](cmp-17-reordering-steps.md)
    * [CMP-18 · Admin campaign Preview](cmp-18-admin-campaign-preview.md)
    * [CMP-19 · Skipped filter](cmp-19-skipped-filter.md)
    * [CMP-20 · Bulk update steps](cmp-20-bulk-update-steps.md)
  * [6‡.13 · What they have in common](6-13-what-they-have-in-common.md)
