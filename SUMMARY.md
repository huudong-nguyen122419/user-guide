...
* [A6 · Talent Active / Passive](a6-talent-active-passive.md)
  ...
  * [A6.x · Edge cases](a6-x-edge-cases.md)
    * [A6.x.1 · In Review queue](a6-x-1-in-review-queue.md)
    * [A6.x.2 · ReviewPassive — resubmit](a6-x-2-reviewpassive-resubmit.md)
    * [A6.x.3 · No bulk status update](a6-x-3-no-bulk-status-update.md)
    * [A6.x.4 · Title vs work experience](a6-x-4-title-vs-work-experience.md)
    * [A6.x.5 · Employers not linked](a6-x-5-employers-not-linked.md)
    * [A6.x.6 · Group C unreachable](a6-x-6-group-c-unreachable.md)
    * [A6.x.7 · Where the reason lives](a6-x-7-where-the-reason-lives.md)
    * [A6.x.8 · Wrong company flags](a6-x-8-wrong-company-flags.md)
    * [A6.x.9 · No operational impact](a6-x-9-no-operational-impact.md)
    * [A6.x.10 · Switch back to In Review](a6-x-10-switch-back-to-in-review.md)
