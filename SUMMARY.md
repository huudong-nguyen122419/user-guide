...
* [4b · Schedule a call](4b-schedule-a-call.md)
  ...
  * [4b.x · Edge cases](4b-x-edge-cases.md)
    * [4b.x.1 · No reschedule](4b-x-1-no-reschedule.md)
    * [4b.x.2 · Two clocks on every row](4b-x-2-two-clocks-on-every-row.md)
    * [4b.x.3 · Which address gets the invite](4b-x-3-which-address-gets-the-invite.md)
