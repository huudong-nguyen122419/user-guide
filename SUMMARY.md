...
* [A6 · Talent Active / Passive](a6-talent-active-passive.md)
  * [A6-A · Existing Passive records (on hold)](a6-a-identify-active-talent.md)
  * [A6-B · Existing Active records (deferred — migration)](a6-b-identify-passive-talent.md)
    * [A6-B.0 · The rules](a6-b-0-the-rules.md)
    ...
    * [A6-B.4 · Set the status Active → Passive (UAT)](a6-b-4-set-status-on-uat.md)
  * [A6-C · Review the In Review queue — LIVE](a6-c-review-in-review-queue.md)
    * [A6-C.6 · The automatic rule, in full (as built)](a6-c-6-the-automatic-rule.md)
