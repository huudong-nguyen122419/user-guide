...
2. **A1.3** — **Fill in the details** — **First name · Last name · Email** (= their login username; use the company email) · **Phone** (optional) · **Roles*** (pick **SDR** or **KAM** — tick both if they cover both) · **Password** (auto-generated). Regenerate / copy the password → [A1.x.1 ↗](a1-x-1-generate-password.md).
