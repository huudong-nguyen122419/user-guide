...
**Message Templates** (left menu) → **+ Create New** → fill **Name*** (how it shows in compose, e.g. `EN 06 - Follow-up`) · **Topic*** · **Source Type** · **Subject EN / DE** · **body EN / DE** (two rich-text editors) → **Create**. Edit/delete via row actions; filter by Topics.
