...
, each with a count: The five tabs account for every record, 57 + 11 + 19 + 4 = 91 in one snapshot. There is no Archived or Scheduled tab; see [A5.x.1 ↗](a5-x-1-no-delete-archive.md).
