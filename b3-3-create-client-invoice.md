...
5. **B3.3.5** — When everything checks out, click **Create**. The invoice is created in **Draft**, tagged **Timesheets (date range)** — review it straight away in [B3.4 ↗](b3-4-review-invoice-and-pdf.md). If there were expenses, the total already includes them.
