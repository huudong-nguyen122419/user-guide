# 5.3 · Pick who's overdue

> 5 · Follow up on silent prospects

**Pick who's overdue:** click the **Last Contact** header to sort (oldest first), then read the **💬 aging icon** next to each date — its **colour** tells you how long since you last touched that contact, so you work the coldest first. The little **red dot** is a "due" flag that clears the moment you make contact.
...
![Aging icons](v3s-62-sdr-list-60s.png)
