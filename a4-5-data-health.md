...
Open **Data Health β**. A campaign that has never been scanned says **“No health snapshot yet”** → **Recompute live**.

## A4.5.2 · Read the verdict + six cards

**Total contacts · In queue · Delivered · Healthy · Critical · Cross-campaign**, with the badge (**HEALTHY** / **CRITICAL**) and the snapshot timestamp.

![Campaign data health](admc-10-data-health.png)

*A4.5 — ① verdict · ② the six cards · ③ Issues & Actions · ④ the three detail columns.*

## A4.5.3 · Work the detail columns

Each line has a **CLEAR** chip when it is at zero — that is the “nothing to fix here” marker, not a button that fixes something.
...
Anything under **Issues & Actions** comes with a **Review →** that jumps to the offending contacts. Clear the Critical ones before flipping **Enabled**.
