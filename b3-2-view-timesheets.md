...
Click **View Timesheets** on the talent's row → opens that talent's monthly calendar.

![View Timesheets link](sdrx-ts-24-admin-view-ts-link.png)

*B3.2.1: ① View Timesheets · ② invoices already created, shown on the same row.*

## B3.2.2 · Reconcile the three totals
...
## B3.2.3 · Check the day cells

A cell shows **“X hrs to bill”**; when that day was adjusted it shows **“X hrs to bill and Y hrs worked”**, along with the time range and the Note the talent wrote.

![View Timesheets](sdrx-ts-08-admin-view-timesheets.png)

*B3.2: the three totals on top; each day cell shows both to bill and worked whenever they differ.*

## B3.2.4

If the numbers agree, close this and move on to invoicing. If they do not, **stop**: check with the talent before billing.
