...
**Read the recommendation.** The status chip reads **In Review** and carries a **⚠ warning icon** beside it. Hover the icon and you get two lines: The full rule, all five questions and every sentence it can print, is in [A6-C.6 ↗](a6-c-6-the-rule-that-runs-today.md).
