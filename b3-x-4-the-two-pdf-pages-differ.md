...
- **Hourly:** page 1 = 6.50 hours and page 2 = *Total Hour(s)* 7.00.

- **Daily:** page 1 = 1.50 days and page 2 = *Total Day(s)* 1.75, **same unit on both pages, which is the most confusing case**.

![Two PDF pages, two figures](tsx-17-pdf-two-pages-diff.png)
