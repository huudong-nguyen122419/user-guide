...
The other half of the listAdding is [7.3 ↗](7-3-add-people-to-the-me.md); this is how people come back out. Same tab, same selection bar — but the confirmation behaves differently enough to be worth its own read.
...
There is no removal history and no bin to fish them out of — the only way back is to add them again from scratch ([7.3 ↗](7-3-add-people-to-the-me.md)). On a **Select all N matching** removal that is a real cost, so read the count in the bar before you confirm, not after.
