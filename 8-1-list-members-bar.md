...
* **Simple view** (default) → **Lifecycles and Has signal**.

* **Full view** → a fuller bar: **Lifecycles, Campaign, Work Experience, Years of Experience, Countries and Cities** (Has signal drops off; Work Experience here is the same power filter as in the Inbox, see 8.3).
