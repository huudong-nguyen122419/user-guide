# B5.1 · Who can see them

> B5 · Talent · find a resource

1. **B5.1.1** — **Three conditions, and all three have to hold.** Fail any one and the talent loses the **Resources** menu entry *and* every block described in [B5.4 ↗](b5-4-where-the-blocks-appear.md) — it is one switch, not several.
