...
> **Easy to misread**
>
> The block happens **at submit time, not at log time**. A talent can log a whole week before discovering they cannot submit, so fill these in as soon as the contract goes Active.
