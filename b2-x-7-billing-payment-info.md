...
- **Add billing address** → the **Tax & Payment Information** drawer: **Account Type** (Individual Professional / Firm — Company) · name · **Birthday** · email · phone · **Address / City / Postcode / Country** · **Tax Identification Number (TIN)**. It also carries **Recipients / Cc / Bcc** — who receives the invoice. Fields marked ***** are required. **B2.x.7c** — **①** Account Type · **②** personal details · **③** address · **④** **TIN is required**, VAT is optional.
