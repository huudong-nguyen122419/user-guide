...
> **The quickest way to see what a talent sees**
>
> On the admin list, pin the **Published Date** quick filter ([B4.1.3 ↗](b4-1-open-resources.md)) and set its **To** to **today**. What comes back is exactly the set on the talent Resources page, in the example above, that is the 19. Anything in the Published tab but not in that filtered list is published and unreachable.
