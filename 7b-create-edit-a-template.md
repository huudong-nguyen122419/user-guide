...
Everything else in the editor has its own edge case below, jump to it: [saved Template (7.x.7)](7-x-7-start-from-a-template.md) and [Variables (7.x.9)](7-x-9-variables.md) and [Snippets (7.x.8)](7-x-8-insert-a-snippet.md) and [CC (7.x.10)](7-x-10-cc.md) and [Upload files (7.x.12)](7-x-12-upload-signature.md) and [Signature (7.x.12)](7-x-12-upload-signature.md) and [Force Update (7.x.11)](7-x-11-force-update.md).

![Marketing Email step editor](sdrx-me-05-step-editor.png)
...
![Template tab with Step 1](sdrx-me-01-template.png)
