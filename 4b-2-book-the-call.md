...
| **Date & time** | **yes** | The form says it outright: *“the meeting cannot be created without a start time”*. Confirm starts disabled, but **do not trust it to stay that way**: see [4b.x.9 ↗](4b-x-9-create-switches-on-with-no-time.md). |
