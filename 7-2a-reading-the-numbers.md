...
| **Open Rate** | % opened, raw count in brackets. *100% (1)* = the one mail delivered was opened. |
| **Reply Rate** | % that got a reply, total replies in brackets. **The number that matters most.** |
