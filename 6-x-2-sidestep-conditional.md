...
*6.x.2 — `Campaign 1 1 1 1 2 0 2 5` on UAT: Main Step (2 steps) plus four branches. `Side Step: Out Of Office` runs three steps of its own on Day 2, Day 3 and Day 4.*
