...
In actionRail opens at **111** companies → **Has signal : Yes** → **111 → 29** firms.

![Company rail Has signal result](sdrx-flt-hassignal-demo.png)

*8.2 — company rail Has signal : Yes → 29 firms.*

![Company rail filters](sdrx-57b-company-rail-filter-sdr.png)

*8.2 · bars — members bar = Lifecycles · Has signal; company rail = Lifecycle · Has signal (+ 🔍 search).*

Same word, two levels"Has signal" on the **rail** = the **company** has news; "Has signal" on the **members bar** (8.1) = the **person** has news. Pick the level you actually want.
