...
**Expense report date** (when the cost was incurred), **Description** (goes onto the invoice), **Currency** (defaults to the contract currency), **Quantity** and **Amount**. The **Total** line calculates itself as Quantity × Amount. You can also **Upload file** to attach the original receipt.
...
click the **N expense report** line → the **Expense reports** dialog: one row per item (date, description, Amount, Quantity and **Total Amount**) with **✎** edit and **🗑** delete buttons, an **Expense date** filter, and a **Grand total** at the bottom.
