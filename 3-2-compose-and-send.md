...
## 3.1 · Check From / To / Cc

Both address fields are pre-filled — check them before sending:
...
![Compose window — From, To, Cc](sdrx-80-compose-from-to-cc.png)

*3.1 — ① From = your profile email (view-only) · ② To = the contact's email (editable, add more) · ③ Cc = copy someone in.*

## 3.2 · Type the Subject yourself

in "Add a subject" at the very top. For a **new** email it starts empty and does **not** auto-fill, even from a Template (known bug). The Send button blocks an empty subject — so you can't forget.

![Subject box](v3s-21-compose-subject.png)

*3.2 — the subject box (red frame) — type it yourself.*

## 3.3 · Write your message

in the body (personalize with their role & signal from Flow 2). Want to start from a Template, drop in a Snippet, or attach a file? See Edge cases (3.x).
...
## 3.5 · See your sent email

The moment you send, your email is logged to the contact's **Conversations**. There are **two ways** to open it — both land on the **same Conversation**: The left pane lists every message; click yours to read it on the right (From = you, To = the contact, plus your signature).
...
![Your sent email at the top of the contact's Conversations](sdrx-82-sent-in-conversation.png)
