...
> **One click, no undo**
>
> It removes everyone ticked, and there is no way back except adding them again. **Read the count on the action bar before you click**, above all after using **Select all N matching**, which reaches past the rows you can see.
