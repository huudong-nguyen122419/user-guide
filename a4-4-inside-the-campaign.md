...
(click the name, or **⋮ → Edit/View Details**). The header carries: editable **name** (✎), **timezone**, **description** and the **owner** with a **⚙** badge and and, once it is live, the **Active** switch.
...
A Draft or Finished campaign shows **Steps, People, Email Queues and Timeline**; once it is running you also get **Inbox** and **Preview**.
