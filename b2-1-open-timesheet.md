...
## B2.1.1 · Sign in to the talent portal

(`talent.fintalent.io`) with the talent account.
...
Open the **☰** menu (top left) → group **Work** → **Timesheet**. (Timesheet lives in the ☰ menu: it is not on the bottom navigation bar.)

![Work menu with Timesheet](sdrx-ts-17-talent-work-menu.png)

*B2.1.2: ① the Work group · ② the Timesheet entry.*

## B2.1.3 · Pick the project to log against
